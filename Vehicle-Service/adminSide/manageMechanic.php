		...
		<label style="top: 10%;" class="form">
			...
			<table cellpadding="7px" border="2px">
				<thead>
					...
					<th style="text-align: center; padding: 8px;">Mechanic name</th>
				...
				<tbody>
					...
					while($row = mysqli_fetch_assoc($result))
					{
					 ?>
					 <tr>
					 	<td style="text-align: center; padding: 8px;"><?php echo $row['mid'];  ?></td>
					 	<td style="text-align: center; padding: 8px;"><?php echo $row['mechanic_name'];  ?></td>
					 	<td style="text-align: center; padding: 8px;"><?php echo $row['mechanic_contact'];  ?></td>
					 	<td style="text-align: center; padding: 8px;"><?php echo $row['mechanic_mail'];  ?></td>
					 	<td style="text-align: center; padding: 8px;"><?php echo $row['mechanic_password'];  ?></td>
					 	<td style="text-align: center; padding: 8px;"><?php echo $row['mechanic_address'];  ?></td>
					 	<td style="text-align: center; padding: 8px;"><?php echo $row['addTime'];  ?></td>
					 	<td style="text-align: center; padding: 8px;"><a href="mechanicUpdate.php?id=<?php echo $row['mid'];?>" style="color: green;">Edit</a></td>
