...
<body>
	...
	background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(98,0,255,1) 0%, rgba(160,30,105,1) 30%, rgba(180,34,114,1) 45%, rgba(214,40,128,1) 65%);"> 
		...
		<ul>
			...
			<li><a href="userRegister.php" style="text-decoration: none; font-weight: bold;">Register Yourself</a></li>
		</ul>
	</nav>
	...
	<div class="indexImg">
		<label style="top: 10%;" class="form">
			...
			<center><a href="index.php"><button class="submit" style="margin-top: 50px;">Back</button></a></center>
		</label>
	</div>
</body>
</html>